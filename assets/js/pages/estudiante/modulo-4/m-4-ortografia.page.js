parasails.registerPage("m-4-ortografia", {
	...
	data: {
		...
		ortografia: {
			...
			titulo: "Ortografia",
			detalle:
				"Con	esta opción se puede controlar la ortografía la gramática y los problemas de escritura.",
			leerMas: "",
			...
			carousel: [
				{
					...
					detalle:
						"Al hacer clic sobre Ortografía y gramática aparecerá la siguiente pantalla. Esta interfaz permite paso a paso revisar las faltas ortográficas del documento.",
				...
				},
				{
					...
					detalle:
						"Dar clic derecho sobre la palabra subrayada en rojo o verde, se mostrará diferentes opciones de escritura correcta.",
				...
				},
				{
					...
					detalle:
						"Finalmente, los errores ortográficos se encuentran corregidos.",
