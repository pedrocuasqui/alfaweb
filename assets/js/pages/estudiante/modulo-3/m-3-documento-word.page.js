	...
	data: {
		...
		word: {
			...
			imgs: [
				{
					src:
						"https://upload.wikimedia.org/wikipedia/commons/thumb/7/76/Microsoft_Office_Word_%282018%E2%80%93present%29.svg/245px-Microsoft_Office_Word_%282018%E2%80%93present%29.svg.png",
					alt: "Microsoft word"
				}
			]
		},
		microsoft: {
			...
			titulo: "Microsoft",
			detalle:
				"Microsoft Corporation es una compañía tecnológica multinacional con sede en Redmond, Washington, EE.UU. Sus productos más conocidos son el sistema operativo Microsoft Windows, la suite ofimática Microsoft Office y los navegadores de Internet, Internet Explorer y Edge. ",
			leerMas: "https://es.wikipedia.org/wiki/Microsoft",
			imgs: [
				{
					src:
						"https://tecnologia-facil.com/wp-content/uploads/2014/12/que-es-microsoft-1.jpg",
					alt: "Microsoft"
				}
			]
		}
