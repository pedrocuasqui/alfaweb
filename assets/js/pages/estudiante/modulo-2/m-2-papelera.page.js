parasails.registerPage("m-2-papelera", {
	...
	data: {
		...
		papeleraVacia: {
			...
			detalle:
				"La papelera de reciclaje se encuentra vacía cuando no se ha borrado ningún archivo",
			leerMas:
				"https://recoverit.wondershare.com/es/deleted-recovery/recycle-bin-recovery.html",
			imgs: [
				{
					src:
						"https://es.seaicons.com/wp-content/uploads/2016/10/System-Recycle-Bin-Empty-icon.png",
		...
		papeleraLlena: {
			...
			detalle:
				"Si el usuario elimina un nuevo archivo y la papelera está por llenarse, reacciona eliminando suficientes archivos para que la carpeta no se llene en exceso. Por tanto el usuario siempre podrá eliminar archivos sin temor a sobrecargar la papelera.",
			leerMas:
				"https://techlandia.com/sucede-papelera-reciclaje-computadora-llena-info_303933/",
			imgs: [
				{
					src:
						"https://www.softzone.es/app/uploads/2017/02/papelera-reciclaje.jpg?",
