parasails.registerPage("m-5-navegador-web", {
	...
	data: {
		...
		edge: {
			...
			detalle:
				"Microsoft Edge es un navegador web desarrollado por Microsoft, que se encuentra incluido en Windows 10, donde reemplazó a Internet Explorer como navegador web preestablecido.   Microsoft Edge está construido en torno a los estándares web, y Microsoft se ha comprometido a actualizar Edge para integrarlo con los nuevos y existentes estándares que aun no soporta. ",
			leerMas: "https://es.wikipedia.org/wiki/Microsoft_Edge",
			imgs: [
				{
					src:
						"https://ep00.epimg.net/tecnologia/imagenes/2015/04/30/actualidad/1430352162_111015_1430352523_noticia_normal.jpg",
					alt: "Microsoft edge"
				}
			]
		},
		chrome: {
			...
			imgs: [
				{
					src:
						"https://www.abc.es/media/tecnologia/2018/09/25/google-chrome-0-kCD--620x349@abc.jpg",
					alt: "Google Chrome"
				}
			]
		},
