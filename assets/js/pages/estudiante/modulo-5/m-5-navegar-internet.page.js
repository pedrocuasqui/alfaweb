parasails.registerPage("m-5-navegar-internet", {
	...
	data: {
		...
		navegar: {
			...
			detalle:
				"En este módulo trataremos el tema de Internet, la gran red de ordenadores que nos permite estar conectados entre personas de todo el mundo, compartir archivos y conocimientos entre todas las personas conectadas estén donde estén.",
			leerMas: "https://ordenadorpractico.es/mod/page/view.php?id=350",
			imgs: [
				{
					src:
						"https://static3.elcorreo.com/www/pre2017/multimedia/noticias/201512/16/media/cortadas/navegaralta--575x323.jpg",
